    ...
    <div id="challenge-1" class="challenge-page">
        ...
        <div class="challenge-container">
            ...
            <div class="challenge-section">
                <h1 class="michroma">&nbsp; <b>#1. </b> Challenge Demo</h1>
                <p style="text-align: center;">Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia error libero cum neque quasi. Hic porro, ea aspernatur esse soluta ab! Ipsam modi sunt atque recusandae quia corporis in? Quo!</p>
            ...
            <div class="challenge-questions">
                <form action="" id="challenge-1" method="POST">
                    <div class="question">
                        ...
                        <input type="text" name="c1q1" id='c1q1' placeholder="hint for the question">
                    </div>
                    <div class="question">
                        <label>Question 2</label>
                        <input type="text" name="c1q2" id='c1q2' placeholder="hint for the question">
                    </div>
                    <div class="question">
                        <label>Question 3</label>
                        <input type="text" name="c1q3" id='c1q3' placeholder="hint for the question">
                    </div>
                    <div class="question">
                        <label>Question 4</label>
                        <input type="text" name="c1q4" id='c1q4' placeholder="hint for the question">
                    </div>
                    <div class="question">
                        <label>Question 5</label>
                        <input type="text" name="c1q5" id='c1q5' placeholder="hint for the question">
                    </div>
                    <?php 
